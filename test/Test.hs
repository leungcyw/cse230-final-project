...
testEnd sc = testGroup "End Conditions" [
    scoreTest ((\_ -> E.die C.defaultGame), (), C.defaultGame, 10, "dead-False", sc)
  , scoreTest ((\_ -> E.die C.testGameDeadBefore), (), C.testGameDeadAfter, 10, "dead-True", sc)
